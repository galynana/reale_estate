      ...
      <div class="container">
        <div class="header__inner">
          ...
          <button class="header__button" type="submit">
            <img src="images/burger.svg" alt="icon-burger" />
          </button>
        </div>
      </div>
    </header>
        ...
        <div class="container">
          <div class="hero-wrapper">
            ...
            <div class="hero__img-wrapper">
              <img class="hero__img" src="images/main-image.jpg" alt="image" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="cards">
            <div class="cards-item">
              <div class="cards-item__wrapper">
                ...
                <a href="#" class="cards__item">
                  <img src="images/flat-1.png" alt="flat-1" class="cards__item-img" />
            ...
            <div class="cards-item">
              <div class="cards-item__wrapper">
                <button class="cards-item__heart"></button>
                <a href="#" class="cards__item">
                  <img src="images/flat-2.png" alt="flat-1" class="cards__item-img" />
                  <div class="cards__item-info">
            ...
            <div class="cards-item">
              <div class="cards-item__wrapper">
                <button class="cards-item__heart"></button>
                <a href="#" class="cards__item">
                  <img src="images/flat-3.png" alt="flat" class="cards__item-img" />
                  <div class="cards__item-info">
                    <span class="cards__item-tag">семейный</span>
                    <span class="cards__item-name">3-комн. кв., 118&nbsp;м², 3/23 этаж</span>
                    <span class="cards__item-house">ЖК «Манхэттен»</span>
            ...
            <div class="cards-item">
              <div class="cards-item__wrapper">
                <button class="cards-item__heart"></button>
                <a href="#" class="cards__item">
                  <img src="images/flat-4.png" alt="flat" class="cards__item-img" />
                  <div class="cards__item-info">
          ...
          <div class="reviews-wrapper">
            <div class="reviews-item">
              <div class="reviews-item__top">
                <img src="images/client-1.png" alt="avatar" class="reviews-item__avatar" />
            ...
            <div class="reviews-item">
              <div class="reviews-item__top">
                <img src="images/client-2.png" alt="avatar" class="reviews-item__avatar" />
                <div class="reviews-item__info">
            ...
            <div class="reviews-item">
              <div class="reviews-item__top">
                <img src="images/client-3.jpg" alt="avatar" class="reviews-item__avatar" />
                <div class="reviews-item__info">
                  <h3 class="reviews-item__title">Подобрали именно то, что я так долго искал</h3>
